...
(function(){
  ...
  function ionSlider($ionicModal,ionGalleryData,$ionicPlatform,$timeout,$ionicScrollDelegate){
    ...
    function link(scope, element, attrs) {
     ...
     scope.share = function (photo,local) 
     {
    var data = {};
    data.image = photo[local].src;
    
    var message = "Guto 13 - Baixe nosso aplicativo";
    var link = "https://goo.gl/jHlQTc";
  ...
  scope.sharefacebook = function (photo,local) 
     {
    var data = {};
    data.image = photo[local].src;
    ...
    //window.plugins.socialsharing.share('Checkout "' + item.title + '" starting on ' + data.startdate + ', ' + data.starttime, null, data.image + 'At ' + item.venue);
     ...
     /*{
      ...
      alert(photo[local].src);
      console.log(photo[local].src);
     };*/
